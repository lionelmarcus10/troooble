  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={cn(
          "p-3 flex flex-col justify-between items-center max-w-96 mx-auto bg-zinc-50 shadow-sm dark:shadow-none dark:bg-zinc-950 rounded-2xl cursor-pointer border border-gray-200/70 dark:border-zinc-900",
          className,
        )}
      >
