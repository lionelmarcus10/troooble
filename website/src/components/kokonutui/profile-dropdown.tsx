            ...
            <DropdownMenu onOpenChange={setIsOpen}>
                <div className="group relative">
                    <DropdownMenuTrigger asChild>
                        <button
                            type="button"
                            className="flex items-center gap-16 md:gap-10 p-3 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800/60 hover:border-zinc-300 dark:hover:border-zinc-700 hover:bg-white-50/80 dark:hover:bg-white-800/40 hover:shadow-sm transition-all duration-200 focus:outline-none"
                        >
                    ...
                    <DropdownMenuContent
                        align="end"
                        sideOffset={4}
                        className="w-64 p-2 ml-5 md:ml-16 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-sm border border-zinc-200/60 dark:border-zinc-800/60 rounded-2xl shadow-xl shadow-zinc-900/5 dark:shadow-zinc-950/20 
